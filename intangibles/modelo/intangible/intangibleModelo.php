...
class intangible
{
    ...
    public function readIntangibleByAdmin()
    {
        ...
        a.pregunta37 'Durante el periodo, han tenido lugar, o van a tener lugar en un futuro inmediato, cambios significativos con una incidencia desfavorable sobre la entidad a largo plazo, los cuales están relacionados con el entorno legal, tecnológico o de política gubernamental, en los que opera la entidad.',
        a.pregunta38 'Justifique su respuesta en caso afirmativo  o negativo.',
        a.pregunta39 'Durante el periodo, el valor de mercado del activo ha disminuido significativamente más que lo que se esperaría como consecuencia del paso del tiempo o de su uso normal.',
        a.pregunta40 'Justifique su respuesta si es afirmativa  y adjunte las evidencias del estudio del mercado que realizó para determinar el valor del mercado.',
        a.pregunta41 'Valor del estudio del mercado (si no se puede estimar el costo del valor del mercado, escribir el costo de reposición).',
        a.pregunta42 'Justifique su respuesta si es negativa indicando el costo de reposición, que es el valor que se incurriría si se tuviera que reponer el bien que se encuentra evaluando, en las mismas condiciones en las que se encuentra. Para esto realice la siguiente pregunta, si tuviera que adquirir este elemento que se encuentra evaluando, ¿cuál sería su costo o valor en el mercado?, ¿ese valor en el que tuviera que incurrir es muy inferior al valor reflejado como VALOR DEL BIEN?.',
        a.pregunta43 'Valor de reposición del activo intangible.',
        a.pregunta44 'Se dispone de evidencia sobre la obsolescencia o daño del activo.',
        a.pregunta45 'Si su respuesta fue afirmativa se debe calcular el valor de dichas rehabilitaciones.',
        a.pregunta46 'Durante el periodo, han tenido lugar, o se espera que tengan lugar en un futuro inmediato, cambios significativos en el grado de utilización o la manera como se usa o se espera usar el activo, los cuales afectarán desfavorablemente la entidad a largo plazo. Estos cambios incluyen el hecho de que el activo esté ocioso, los planes de discontinuación o restructuración de la operación a la que pertenece el activo, los planes para disponer el activo antes de la fecha prevista y el cambio de la vida útil de un activo de indefinida a finita.',
        a.pregunta47 'Justifique su respuesta si es afirmativa o negativa',
        a.pregunta48 'Se decide detener la construcción del activo antes de su finalización o de su puesta en condiciones de funcionamiento, salvo que exista evidencia objetiva de que se reanudará la construcción en el futuro próximo.',
        a.pregunta49 'Justifique su respuesta si es afirmativa o negativa.',
        a.pregunta50 'Se dispone de información procedente de informes internos que indican que la capacidad del activo para suministrar bienes o servicios ha disminuido o va a ser inferior a la esperada.',
