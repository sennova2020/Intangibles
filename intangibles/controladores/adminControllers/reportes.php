...
function downloadExcelReport($project)
{
	...
	if (isset($result)) {
		...
		foreach ($result as $row){ 
                    ...
                    ->setCellValue("L$i", utf8_encode($row['¿El intangible es un recurso controlado?']))
                    ...
                    ->setCellValue("P$i", utf8_encode($row['¿El intangible se puede medir fiablemente?']))
                    ...
                    ->setCellValue("V$i", utf8_encode($row['¿El intangible es sin apariencia física?']))
                    ...
                    ->setCellValue("X$i", utf8_encode($row['¿El intangible se va a utilizar por más de un año?']))
                    ...
                    ->setCellValue("BE$i", utf8_encode($row['Durante el periodo, han tenido lugar, o van a tener lugar en un futuro inmediato, cambios significativos con una incidencia desfavorable sobre la entidad a largo plazo.']))
                    ...
                    ->setCellValue("BJ$i", utf8_encode($row['Justifique su respuesta si es negativa indicando el costo de reposición.']))
