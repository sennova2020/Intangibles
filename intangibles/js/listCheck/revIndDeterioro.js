function descriptionModal(e) {
    ...
    if (object == "changesNote") {
        ...
        message = 'El valor del mercado es el valor por el cual el bien intangible puede ser intercambiado entre partes interesadas y debidamente informadas, en una transacción realizada en condiciones de independencia mutua (valor del intangible en el mercado, si se pusiera en venta); el mercado debe presentar condiciones de ser abierto, activo y ordenado.Si se cuenta con evidencia objetiva de algunas de las siguientes situaciones se debe marcar “SI”.<br> A continuación, se enumeran algunos ejemplos:Un intangible que ha disminuido su “valor de mercado” como consecuencia de la disminución de la materia prima y/o mano de obra con que se elabora el intangible.<br><br>1)Un intangible que ha disminuido su “valor de mercado” como consecuencia del ingreso al mercado de otras tecnologías que desarrollan las mismas actividades, pero con mejor definición, velocidad, capacidad, etc.<br><br>3)Sale al mercado una nueva versión o un nuevo modelo del intangible que vuelve obsole.El valor del mercado es el valor por el cual el bien intangible puede ser intercambiado entre partes interesadas y debidamente informadas, en una transacción realizada en condiciones de independencia mutua (valor del intangible en el mercado, si se pusiera en venta); el mercado debe presentar condiciones de ser abierto, activo y ordenado.Si se cuenta con evidencia objetiva de algunas de las siguientes situaciones se debe marcar “SI”.<br> A continuación, se enumeran algunos ejemplos:Un intangible que ha disminuido su “valor de mercado” como consecuencia de la disminución de la materia prima y/o mano de obra con que se elabora el intangible.<br><br>1)Un intangible que ha disminuido su “valor de mercado” como consecuencia del ingreso al mercado de otras tecnologías que desarrollan las mismas actividades, pero con mejor definición, velocidad, capacidad, etc.<br><br>3)Sale al mercado una nueva versión o un nuevo modelo del intangible que vuelve obsole.';
        ...
        message = 'Un bien intangible que ha recibido ataque cibernético, robo, de información, secuestro de información o algun hecho que imposiviliten el normal funcionamiento del activo. Un intangible que no se puede utilizar debido a que no cuenta con infraestructura para su utilización. ';
    }else if(object == 'activeEvaluation'){
        message = 'Con esta pregunta se pretende identificar si el activo que se encuentra en evaluación, se dejó de utilizar o se piensa dejar de utilizar, inclusive si se cuenta con un plan para reemplazar el elemento o no utilizarlo hasta la fecha contemplada inicialmente por circunstancias diferentes al daño físico del elemento.<br> Acontinuación, se enumeran algunos ejemplos de circunstancias:<br><br>1) Si un bien intangible no se está utilizando en el mismo grado que cuando se puso en funcionamiento, o si la vida útil estimada del activo es menor que la que originalmente se estimó; es decir se planteó inicalmente su uso en un determinado tiempo y ahora se prevé su uso en un tiempo menor.<br><br>2) Un bien intangible creado con un fin especifico y se encuentra en uso en un tema muy diferente al original. Un ejemplo de esto es un software con fines de formación  profesional en un tema especifico y el SENA deja de ofrecer dicha formación profesional.';
